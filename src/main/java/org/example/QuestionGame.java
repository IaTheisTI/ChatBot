...
public class QuestionGame {
    ...
    public QuestionGame() {
        ...
        puzzles.put("Какая самая популярная версия Windows на данный момент?", new Game("Какая самая популярная версия Windows на данный момент?", "10", "К сожалению это не 7"));
        puzzles.put("Сколько весит Quake 3?", new Game("Сколько весит Quake 3?", "2гб", "Сколько видеопамяти в gt1030..."));
        puzzles.put("Как называется время за которое ЭВМ выполняет действие?", new Game("Как называется время за которое ЭВМ выполняет действие?", "такт", "Есть такой батончик тик - ...."));
    ...
    public String getStatistics(long chatId) {
        ...
        int total = 4; // Общее количество загадок
